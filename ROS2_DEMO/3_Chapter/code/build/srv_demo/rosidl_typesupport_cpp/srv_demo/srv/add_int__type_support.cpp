...
static const _AddInt_Request_type_support_symbol_names_t _AddInt_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_demo, srv, AddInt_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, srv_demo, srv, AddInt_Request)),
  }
};
...
{
  return &::srv_demo::srv::rosidl_typesupport_cpp::AddInt_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, srv_demo, srv, AddInt_Request)() {
  return get_message_type_support_handle<srv_demo::srv::AddInt_Request>();
}
...
static const _AddInt_Response_type_support_symbol_names_t _AddInt_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_demo, srv, AddInt_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, srv_demo, srv, AddInt_Response)),
  }
};
...
{
  return &::srv_demo::srv::rosidl_typesupport_cpp::AddInt_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, srv_demo, srv, AddInt_Response)() {
  return get_message_type_support_handle<srv_demo::srv::AddInt_Response>();
}
...
static const _AddInt_type_support_symbol_names_t _AddInt_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_demo, srv, AddInt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, srv_demo, srv, AddInt)),
  }
};
...
{
  return &::srv_demo::srv::rosidl_typesupport_cpp::AddInt_service_type_support_handle;
}
