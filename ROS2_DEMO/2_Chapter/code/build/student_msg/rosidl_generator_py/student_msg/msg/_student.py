...
class Metaclass_Student(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('student_msg')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'student_msg.msg.Student')
            logger.debug(
    ...
    def exam(self, value):
        if __debug__:
            assert \
                ...
                "The 'exam' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'exam' field must be an integer in [-2147483648, 2147483647]"
        self._exam = value
