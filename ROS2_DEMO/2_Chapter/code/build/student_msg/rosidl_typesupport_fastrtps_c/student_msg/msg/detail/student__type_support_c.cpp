...
#include "student_msg/msg/detail/student__rosidl_typesupport_fastrtps_c.h"
...
#include "student_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Student__ros_msg_type = student_msg__msg__Student;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_student_msg
size_t get_serialized_size_student_msg__msg__Student(
  const void * untyped_ros_message,
...
static uint32_t _Student__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_student_msg__msg__Student(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_student_msg
size_t max_serialized_size_student_msg__msg__Student(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Student__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_student_msg__msg__Student(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, student_msg, msg, Student)() {
