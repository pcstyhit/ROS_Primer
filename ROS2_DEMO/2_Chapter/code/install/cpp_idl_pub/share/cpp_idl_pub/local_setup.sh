...
: ${AMENT_CURRENT_PREFIX:="/mnt/hgfs/VMware/ROS2_DEMO/2_Chapter/code/install/cpp_idl_pub"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_idl_pub/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_idl_pub/environment/path.sh"
