...
: ${AMENT_CURRENT_PREFIX:="/mnt/hgfs/VMware/ROS2_DEMO/3_Chapter/code/install/cpp_srv_server"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_srv_server/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_srv_server/environment/path.sh"
