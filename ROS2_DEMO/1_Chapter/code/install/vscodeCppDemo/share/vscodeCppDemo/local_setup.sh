...
: ${AMENT_CURRENT_PREFIX:="/mnt/hgfs/VMware/ROS2_DEMO/1_Chapter/code/install/vscodeCppDemo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vscodeCppDemo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vscodeCppDemo/environment/path.sh"
