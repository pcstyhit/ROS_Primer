...
: ${AMENT_CURRENT_PREFIX:="/mnt/hgfs/VMware/ROS2_DEMO/4_Chapter/code/install/cpp_para_client"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_para_client/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_para_client/environment/path.sh"
