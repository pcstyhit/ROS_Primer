...
#include "srv_demo/srv/detail/add_int__rosidl_typesupport_fastrtps_c.h"
...
#include "srv_demo/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _AddInt_Request__ros_msg_type = srv_demo__srv__AddInt_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_srv_demo
size_t get_serialized_size_srv_demo__srv__AddInt_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddInt_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_srv_demo__srv__AddInt_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_srv_demo
size_t max_serialized_size_srv_demo__srv__AddInt_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddInt_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_srv_demo__srv__AddInt_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, srv_demo, srv, AddInt_Request)() {
...
using _AddInt_Response__ros_msg_type = srv_demo__srv__AddInt_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_srv_demo
size_t get_serialized_size_srv_demo__srv__AddInt_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddInt_Response__ros_msg_type * ros_message = static_cast<const _AddInt_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_srv_demo__srv__AddInt_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_srv_demo
size_t max_serialized_size_srv_demo__srv__AddInt_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddInt_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_srv_demo__srv__AddInt_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, srv_demo, srv, AddInt_Response)() {
...
// already included above
// #include "srv_demo/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "srv_demo/srv/add_int.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, srv_demo, srv, AddInt)() {
